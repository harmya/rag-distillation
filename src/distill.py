...
if __name__ == "__main__":
    ...
    if num_gpus > 1:
        student = nn.parallel.DistributedDataParallel(student, device_ids=[i for i in range(num_gpus)])
        teacher = nn.parallel.DistributedDataParallel(teacher, device_ids=[i for i in range(num_gpus)])
